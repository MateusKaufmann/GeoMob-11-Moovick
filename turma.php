...
$numero_linhas_cont = mysqli_fetch_array(mysqli_query($connect, "SELECT COUNT(id) FROM conteudos;"));
$numero_linhas_cont_turma = mysqli_fetch_array(mysqli_query($connect, "SELECT COUNT(id) FROM conteudos WHERE codigo = '$turma_acesso';"));
$numero_linhas_cont2 = mysqli_query($connect, "SELECT * FROM `$id` WHERE id = '$turma_acesso';");
if (mysqli_num_rows($numero_linhas_cont2) <= 0) {
    header('Location: index.php');
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="row fonte d-flex justify-content-center">
                        <div class="col-sm-8" style="padding-bottom: 1rem;">
                            <div class="card">
                                <h5 class="card-header">Curso <?php echo $dados2['nome'] ?></h5>
                                <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                if (intval($numero_linhas_cont[0]) > 0) {
                                                    for ($i = 1; $i <= intval($numero_linhas_cont[0]); $i++) {
                                                        $turma2 = $turma_acesso;

                                                        $titulo = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM conteudos WHERE (conteudos.codigo = '$turma2') AND (id = $i);"));
                                                        if ($titulo != "") {
                                                ...
                                                <td>Ainda não há conteúdos neste curso.</td>
                                                <td></td>
